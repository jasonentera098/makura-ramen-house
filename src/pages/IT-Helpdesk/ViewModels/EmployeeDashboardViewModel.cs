...
namespace IT_Helpdesk.ViewModels
{
    public class EmployeeDashboardViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Ticket> _myTickets = new();
        private ObservableCollection<Ticket> _recentTickets = new();
        private int _myTicketsCount;
        ...
        {
            _myTickets = new ObservableCollection<Ticket>();
        ...
        public int MyTicketsCount
        {
            get => _myTicketsCount;
            set => SetProperty(ref _myTicketsCount, value);
        }
        ...
        public ICommand SubmitTicketCommand { get; private set; } = null!;
        ...
        private async Task LoadTicketsAsync()
        {
            try
            {
                ...
                // Load tickets submitted by the current employee
                var tickets = await _ticketService.GetTicketsByUserAsync(SessionManager.CurrentUser.UserID, "Employee");
        ...
        private void NavigateToSubmitTicket()
        {
            // Navigate to ticket submission page
            // This will be implemented in Task 11
            MessageBox.Show("Submit Ticket functionality will be implemented in Task 11", 
