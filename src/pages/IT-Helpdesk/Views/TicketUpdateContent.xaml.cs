...
{
    /// <summary>
    /// Interaction logic for TicketUpdateContent.xaml
    /// </summary>
    public partial class TicketUpdateContent : UserControl
    {
        private TicketUpdateViewModel? ViewModel => DataContext as TicketUpdateViewModel;

        public TicketUpdateContent()
        {
            InitializeComponent();
        }
