...
# Shows all tickets in the RUNTIME database
...
"@
    ...
    $ticketCount = 0
    Write-Host "Current Tickets in RUNTIME Database:" -ForegroundColor Cyan
    ...
    Write-Host "Note: If the database is locked, close the application first." -ForegroundColor Yellow
    exit 1
} finally {
