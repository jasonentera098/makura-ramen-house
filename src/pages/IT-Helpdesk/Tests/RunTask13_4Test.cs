...
{
    /// <summary>
    /// Standalone test runner for Task 13.4: Set DateResolved=Now when status changes to "Resolved"
    /// Run with: dotnet run --project Tests/RunTask13_4Test.cs
    /// </summary>
    public class RunTask13_4Test
    {
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                if (technician == null)
                {
                    ...
                    Console.WriteLine("Please ensure test data exists in the database.");
                    return;
                }
                ...
                // Update status to Resolved using the service method
